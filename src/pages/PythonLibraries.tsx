...
const PythonLibrariesCourse = () => {
  const [formData, setFormData] = useState({
    name: '',
    email: '',
    phone: '',
    subject: 'Python Libraries Mastery Course Enrollment',
    message: 'I would like to enroll in the Python Libraries Mastery course.',
  });
  ...
  const syllabus = [
    {
      ...
      icon: Database,
      image: 'https://images.pexels.com/photos/6256253/pexels-photo-6256253.jpeg',
      topics: [
      ...
      handsOn: 'Performing efficient numerical calculations on large datasets'
    },
    {
      day: 2,
      title: 'Data Analysis with Pandas',
      icon: Grid,
      image: 'https://images.pexels.com/photos/33401701/pexels-photo-33401701.jpeg',
      topics: [
        'Introduction to Series and DataFrames',
        'Data loading, cleaning, and preprocessing',
        'Handling missing values, duplicates, and data types',
        'Data grouping, aggregation, and merging'
      ],
      handsOn: 'Cleaning and preparing a real-world dataset for analysis'
    },
    {
      day: 3,
      ...
      topics: [
        ...
        'Subplots and advanced figure layouts'
      ],
      handsOn: 'Building various plots to visualize data insights'
    },
    {
      day: 4,
      ...
      topics: [
        'Introduction to Seaborn for aesthetic plots',
        'Creating complex statistical plots (heatmaps, boxplots)',
        'Visualizing relationships between variables',
        'Final project: end-to-end data analysis workflow'
      ],
      handsOn: 'Generating advanced visualizations and a full data analysis report'
    }
  ];
  ...
  const whyChoose = [
    {
      ...
      description: 'Learn by simulating real-world data analysis tasks with industry-standard tools.'
    },
    {
      icon: User,
      title: 'Expert Trainer',
      description: 'Learn from an industry expert with extensive experience in data science and Python.'
    },
    {
      icon: Award,
    ...
    },
    {
      ...
      description: 'Gain proficiency in the core libraries essential for a career in data science, analytics, or machine learning.'
    }
  ];
    ...
    <div className="min-h-screen bg-black pt-24 pb-16">
      ...
      <section className="relative py-40 bg-gradient-to-br from-black via-gray-900 to-purple-950 overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute bottom-20 right-20 w-80 h-80 bg-fuchsia-400 rounded-full filter blur-3xl animate-pulse delay-1000"></div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold mb-6 leading-tight">
                <span className="text-white">Python Libraries</span>
                <br />
              ...
              <p className="text-xl lg:text-2xl text-gray-300 mb-2 font-semibold">
                Master NumPy, Pandas, Matplotlib & Seaborn
              </p>
              
              <p className="text-lg text-gray-400 mb-8">
                4 Days Intensive | From basics to analysis | Hands-on Projects
              </p>
              ...
              <a
                ...
                className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-purple-500 to-fuchsia-400 text-white rounded-full font-semibold text-lg hover:from-purple-600 hover:to-fuchsia-500 transition-all duration-300 hover:scale-105 shadow-2xl hover:shadow-purple-500/50"
              >
                Enroll Today
            ...
            <div className="flex justify-center">
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-purple-500 to-fuchsia-400 rounded-3xl transform rotate-3 scale-105 opacity-20"></div>
                <img
                  src="https://images.pexels.com/photos/9783346/pexels-photo-9783346.jpeg"
                  alt="A programmer working with Python libraries"
                  className="relative rounded-3xl shadow-2xl max-w-md lg:max-w-lg hover:scale-105 transition-transform duration-500"
                />
                
                {/* Floating Elements */}
                <div className="absolute -top-4 -left-4 bg-gradient-to-r from-purple-500 to-fuchsia-400 p-3 rounded-2xl shadow-lg animate-bounce">
                  <Code className="h-6 w-6 text-white" />
                </div>
                <div className="absolute -bottom-4 -right-4 bg-gradient-to-r from-fuchsia-400 to-purple-500 p-3 rounded-2xl shadow-lg animate-bounce delay-1000">
                ...
                >
                  <div className="relative h-48">
                    ...
                    <div className="absolute top-4 left-4">
                      <div className="p-3 bg-gradient-to-r from-purple-500 to-fuchsia-400 rounded-xl">
              ...
              return (
                ...
                >
                  <div className="flex justify-center mb-4">
                    <div className="p-4 bg-gradient-to-r from-purple-500 to-fuchsia-400 rounded-xl">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-300 max-w-2xl mx-auto">
                Secure your spot in our next Python libraries batch. Only 20 seats available!
              </p>
            </div>
              ...
              <div className="bg-gray-800 rounded-2xl p-8 border border-gray-700">
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    <div className="p-2 bg-gradient-to-r from-purple-500 to-fuchsia-400 rounded-lg">
                ...
                {/* Price Section */}
                <div className="mt-8 p-6 bg-gradient-to-r from-purple-900/50 to-fuchsia-900/50 rounded-xl border border-purple-700">
                ...
                {!isSubmitted ? (
                  <>
                    <h3 className="text-2xl font-bold text-white mb-6">
                      Enroll in Python Libraries Mastery
                    </h3>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <button
                        type="submit"
                        className="w-full px-8 py-4 bg-gradient-to-r from-purple-500 to-fuchsia-400 text-white rounded-xl font-semibold hover:from-purple-600 hover:to-fuchsia-500 transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-purple-500/25 flex items-center justify-center"
                      >
                        Secure My Spot
                  ...
                  <div className="text-center py-8">
                    <div className="flex justify-center mb-6">
                      <div className="p-4 bg-gradient-to-r from-purple-500 to-fuchsia-400 rounded-full">
                    ...
                    <p className="text-gray-300 mb-6 leading-relaxed">
                      Thank you for enrolling in Python Libraries Mastery! We'll contact you within 24 hours with course details and payment instructions.
                    </p>
                    <button
                      onClick={() => setIsSubmitted(false)}
                      className="px-6 py-3 bg-gradient-to-r from-purple-500 to-fuchsia-400 text-white rounded-full font-medium hover:from-purple-600 hover:to-fuchsia-500 transition-all duration-300"
                    >
...
export default PythonLibrariesCourse;