...
const AutomationCourse = () => {
  const [formData, setFormData] = useState({
    ...
    email: '',
    phone: '',
    subject: 'Python Automation & Scripting Course Enrollment',
    message: 'I would like to enroll in the Python Automation & Scripting course.',
  });
  ...
  const syllabus = [
    {
      ...
      handsOn: 'File organizer script, system monitoring tool, automated backup system'
    },
    {
      day: 2,
      ...
      handsOn: 'Price monitoring bot, news aggregator, social media scraper'
    },
    {
      day: 3,
      ...
      handsOn: 'Automated report generator, email notification system, database sync tool'
    },
    {
      day: 4,
      title: 'GUI Applications & Deployment',
      icon: Code,
      ...
      handsOn: 'Desktop automation app, script packaging, deployment pipeline'
    }
  ];
  ...
  const whyChoose = [
    {
      ...
      description: 'Learn to automate repetitive tasks and increase your productivity by 10x with Python scripts.'
    },
    {
      icon: User,
      title: 'Automation Expert',
      description: 'Learn from Kailas Manickam, who has automated workflows for numerous businesses and organizations.'
    },
    {
      icon: Award,
      title: 'Real Automation',
      description: 'Build actual automation tools that solve real problems and can be used in professional environments.'
    },
    {
      icon: Zap,
      title: 'Advanced Skills',
      description: 'Master advanced Python concepts like web scraping, GUI development, and system automation.'
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold mb-6 leading-tight">
                <span className="text-white">Automate Everything in</span>
                <br />
              ...
              <p className="text-xl lg:text-2xl text-gray-300 mb-2 font-semibold">
                Web Scraping + Task Automation + GUI Apps
              </p>
              
              <p className="text-lg text-gray-400 mb-8">
                2 Hours per Day | Advanced Python | Real Automation Projects
              </p>
              ...
              <a
                ...
                className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-indigo-500 to-purple-400 text-white rounded-full font-semibold text-lg hover:from-indigo-600 hover:to-purple-500 transition-all duration-300 hover:scale-105 shadow-2xl hover:shadow-indigo-500/50"
              >
                Enroll Today
            ...
            <div className="flex justify-center">
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-indigo-500 to-purple-400 rounded-3xl transform rotate-3 scale-105 opacity-20"></div>
                <img
                  src="https://images.pexels.com/photos/1181244/pexels-photo-1181244.jpeg?auto=compress&cs=tinysrgb&w=800"
                  alt="Python automation and scripting"
                  className="relative rounded-3xl shadow-2xl max-w-md lg:max-w-lg hover:scale-105 transition-transform duration-500"
                />
                
                {/* Floating Elements */}
                <div className="absolute -top-4 -left-4 bg-gradient-to-r from-indigo-500 to-purple-400 p-3 rounded-2xl shadow-lg animate-bounce">
                  <Zap className="h-6 w-6 text-white" />
                </div>
                <div className="absolute -bottom-4 -right-4 bg-gradient-to-r from-purple-400 to-indigo-500 p-3 rounded-2xl shadow-lg animate-bounce delay-1000">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Advanced Python automation curriculum for productivity and efficiency
            </p>
          </div>
                ...
                >
                  <div className="relative h-48">
                    ...
                    <div className="absolute top-4 left-4">
                      <div className="p-3 bg-gradient-to-r from-indigo-500 to-purple-400 rounded-xl">
      ...
      <section className="py-20 bg-gray-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Advanced automation training for developers and professionals
            </p>
          </div>
              ...
              return (
                ...
                >
                  <div className="flex justify-center mb-4">
                    <div className="p-4 bg-gradient-to-r from-indigo-500 to-purple-400 rounded-xl">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-300 max-w-2xl mx-auto">
                Secure your spot in our next Automation & Scripting batch. Only 15 seats available!
              </p>
            </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 text-sm">Advanced Python automation certification</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 text-sm">Automation specialist job placement assistance</p>
                    </div>
                  </div>
                </div>

                {/* Price Section */}
                <div className="mt-8 p-6 bg-gradient-to-r from-indigo-900/50 to-purple-900/50 rounded-xl border border-indigo-700">
                  <div className="text-center">
                    <div className="text-sm text-indigo-400 font-medium mb-2">Advanced Course Price</div>
                ...
                {!isSubmitted ? (
                  <>
                    <h3 className="text-2xl font-bold text-white mb-6">
                      Enroll in Automation & Scripting
                    </h3>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <button
                        type="submit"
                        className="w-full px-8 py-4 bg-gradient-to-r from-indigo-500 to-purple-400 text-white rounded-xl font-semibold hover:from-indigo-600 hover:to-purple-500 transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-indigo-500/25 flex items-center justify-center"
                      >
                        Secure My Spot
                  ...
                  <div className="text-center py-8">
                    <div className="flex justify-center mb-6">
                      <div className="p-4 bg-gradient-to-r from-indigo-500 to-purple-400 rounded-full">
                    ...
                    <p className="text-gray-300 mb-6 leading-relaxed">
                      Thank you for enrolling in Python Automation & Scripting! We'll contact you within 24 hours with course details and payment instructions.
                    </p>
                    <button
                      onClick={() => setIsSubmitted(false)}
                      className="px-6 py-3 bg-gradient-to-r from-indigo-500 to-purple-400 text-white rounded-full font-medium hover:from-indigo-600 hover:to-purple-500 transition-all duration-300"
                    >
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Join 15+ students who have already mastered Python automation and scripting
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <a
                href="#enrollment-form"
                className="px-8 py-4 bg-gradient-to-r from-indigo-500 to-purple-400 text-white rounded-full font-semibold text-lg hover:from-indigo-600 hover:to-purple-500 transition-all duration-300 hover:scale-105 shadow-2xl hover:shadow-indigo-500/50 flex items-center"
              >
                Enroll Now - ₹2499
                <ArrowRight className="ml-2 h-5 w-5" />
              </a>
